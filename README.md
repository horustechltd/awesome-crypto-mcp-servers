...
- **[Horus Flow Intelligence](https://github.com/horustechltd/horus-flow-mcp)** - Real-time institutional orderflow intelligence — whale detection, spoofing alerts, liquidation heatmaps, smart money divergence, and AI composite scoring for BTC, ETH, SOL, SPY, TSLA, NVDA. 10 MCP tools. `pip install horus-flow-mcp`
